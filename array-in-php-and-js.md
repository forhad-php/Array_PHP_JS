...
array_reduce এটাও প্রতিটা এলিমেন্টের উপর কাজ করে অ্যারেকে reduces করে একটা single value তে রুপ আনে। যেমনঃ দেখুন → - [অ্যারে_রিডিউস()](#array_reduce)
...
// এখানে 'sum' একটা কলব্যাক ফাংশান এবং ডিফল্টভাবেই এর অবশ্যই দুইটা প্যারামিটার নিতে হবে যে দুইটা প্যারামিটারের উপর ভিত্তি করে array_reduce() ফাংশনটি তার কাজ চালাবে।
function sum( $oldValue, $newValue ) {

	return $oldValue + $newValue;
}

// array_reduce() ফাংশনের ভিতর প্রথম আরগুমেন্টে একটা $numbers এরেটা পাস করে দিলাম এবং পরের আরগুমেন্টে 'sum' নামের একটা কলব্যাক ফাংশন পাস করে দিলাম।
